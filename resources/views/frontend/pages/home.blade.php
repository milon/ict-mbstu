...
@section('content')
    ...
    <section id="feature" >
        <div class="container">
            <div class="center wow fadeInDown">
                <h2>Welcome to Department of <br>Information and Communication Technology</h2>
                <p class="lead">
    ...
    </section><!--/#Officers and Staffs of the Department-->
    ...
    </section><!--/#Resources of ICT Department-->
